...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    zooAnimals.forEach(animal_info => {
      animal_info.push(animal_name)
    })
    return `name: ${displayNames.animal_name}, scientific: ${scientific_name}`
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter(el => el.population < 5);
  return lowPop
  }
  ...
  */
  ...
  function USApop(array){
    const population = array.map(el => el.population)
      return population.reduce((total, curr) => total + curr, 0)
  }
...
function greeting(firstName, lastName){
  ...
  //console.log('greeting', greeting('Jon', 'Snow'));
...
console.log('gretting',consume("Jon", "Snow", greeting)); // Hello Mary Poppins, nice to meet you!
